...
from .views import (ProductPageView, ProductDetailView, AddProductToFavoriteView,
...
urlpatterns = [
    ...
    path("category/<cat_slug>", ProductPageView.as_view(), name="product_category_page"),
    path("brand/<brand_slug>", ProductPageView.as_view(), name="product_brand_page"),
